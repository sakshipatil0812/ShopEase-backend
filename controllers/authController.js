...
const forgotPassword = async (req, res) => {
  try {
    ...
    res.status(200).json({
      ...
      instructions: 'Use this token to reset your password within 10 minutes',
    });
  } catch (error) {
...
module.exports = { register, login, getMe, updateProfile, forgotPassword, resetPassword, getOrderHistory };
